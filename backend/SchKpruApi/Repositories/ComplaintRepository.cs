...
namespace SchKpruApi.Repositories
{
    public class ComplaintRepository : GenericRepository<Complaint>, IComplaintRepository
    {
        ...
        public async Task<(IEnumerable<Complaint>, int)> GetFilteredAsync(string? searchTerm, string? status, int page, int pageSize)
        {
            var query = _dbSet
                .Include(c => c.UpdatedByUser)
                .AsQueryable();
        ...
        public async Task<IEnumerable<Complaint>> GetByUserRoleAsync(int userId, string roleName, int? departmentId, int? groupId)
        {
            var query = _dbSet
                .Include(c => c.UpdatedByUser)
                .Include(c => c.ComplaintAssignments)
        ...
        public async Task<(IEnumerable<Complaint>, int)> GetFilteredByUserRoleAsync(string? searchTerm, string? status, int page, int pageSize, int userId, string roleName, int? departmentId, int? groupId)
        {
            var query = _dbSet
                .Include(c => c.UpdatedByUser)
                .Include(c => c.ComplaintAssignments)
