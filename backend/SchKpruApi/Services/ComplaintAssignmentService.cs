...
namespace SchKpruApi.Services
{
    public class ComplaintAssignmentService : IComplaintAssignmentService
    {
        ...
        public async Task<ComplaintAssignmentResponseDto> CreateAssignmentAsync(ComplaintAssignmentCreateDto createDto, int assignedByUserId)
        {
        ...
        public async Task<IEnumerable<ComplaintAssignmentResponseDto>> GetAssignmentsByDepartmentIdAsync(int departmentId)
        {
        ...
        private static ComplaintAssignmentResponseDto MapToResponseDto(ComplaintAssignment assignment)
        {
            return new ComplaintAssignmentResponseDto
            {
                ...
                AssignedToUserName = assignment.AssignedToUser != null ? 
                    $"{assignment.AssignedToUser.Name} {assignment.AssignedToUser.Lastname}" : null,
