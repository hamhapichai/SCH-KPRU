...
{
    [Key] [Column("log_id")] public int LogId { get; set; }
    ...
    [Required] [Column("action")] public string Action { get; set; } = string.Empty;

    [Column("notes")] public string? Notes { get; set; }

    [Column("previous_status")] public string? PreviousStatus { get; set; }
    ...
    [Column("related_assignment_id")] public int? RelatedAssignmentId { get; set; }
    ...
    [ForeignKey("RelatedAssignmentId")] public virtual ComplaintAssignment? RelatedAssignment { get; set; }
