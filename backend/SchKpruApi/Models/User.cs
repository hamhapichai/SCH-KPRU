...
namespace SchKpruApi.Models
{
    ...
    public class User
    {
        ...
        public virtual ICollection<ComplaintAssignment> AssignedByComplaintAssignments { get; set; } = new List<ComplaintAssignment>();
        public virtual ICollection<ComplaintAssignment> AssignedToComplaintAssignments { get; set; } = new List<ComplaintAssignment>();
        ...
        public virtual ICollection<ComplaintAssignment> UpdatedComplaintAssignments { get; set; } = new List<ComplaintAssignment>();
