...
public class ComplaintAssignment
{
    ...
    [Column("assigned_to_dept_id")] public int? AssignedToDeptId { get; set; }

    [Column("assigned_to_group_id")] public int? AssignedToGroupId { get; set; }

    [Column("assigned_to_user_id")] public int? AssignedToUserId { get; set; }

    [Column("target_date")] public int? TargetDate { get; set; }

    [Required] [Column("status")] public string Status { get; set; } = string.Empty;

    [Column("assigned_date")] public DateTime AssignedDate { get; set; } = DateTime.UtcNow;
    ...
    [ForeignKey("AssignedToDeptId")] public virtual Department? AssignedToDepartment { get; set; }

    [ForeignKey("AssignedToGroupId")] public virtual Group? AssignedToGroup { get; set; }

    [ForeignKey("AssignedToUserId")] public virtual User? AssignedToUser { get; set; }
